	...
	public class DoYourThing
	{
		...
		public static void Postfix(GameInfo gameInfo)
		{
			if (gameInfo.gamePhase == GamePhase.PLAY && gameInfo.playPhase == PlayPhase.FIRST_DAY)
			{
				...
				Debug.LogWarning(Service.Game.Sim.simulation.validPlayerCount.Get());
				for (int i = 1; i < 16; i++)
				{
					try
					{
		...
		// Token: 0x0600000A RID: 10 RVA: 0x00002B54 File Offset: 0x00000D54
		...
		// Token: 0x0600000B RID: 11 RVA: 0x00002C90 File Offset: 0x00000E90
		static DoYourThing()
		{
		...
		// Token: 0x0600000D RID: 13 RVA: 0x00002D20 File Offset: 0x00000F20
		...
		// Token: 0x0600001E RID: 30 RVA: 0x00003A5C File Offset: 0x00001C5C
