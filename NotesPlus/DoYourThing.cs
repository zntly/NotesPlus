...
namespace NotesPlus
{
	...
	public class DoYourThing
	{
		...
		// Token: 0x0600000A RID: 10 RVA: 0x00002B64 File Offset: 0x00000D64
		...
		// Token: 0x0600000B RID: 11 RVA: 0x00002CD4 File Offset: 0x00000ED4
		static DoYourThing()
		{
		...
		// Token: 0x0600000D RID: 13 RVA: 0x00002D64 File Offset: 0x00000F64
		...
		// Token: 0x0600001C RID: 28 RVA: 0x000032A8 File Offset: 0x000014A8
		public static void TheGoodStuff(string str, int key)
		{
			...
			else if (tuple != null)
			{
				...
				if (!flag6 && ModSettings.GetBool("Traitor Detections", "synapsium.notes.plus"))
				{
		...
		// Token: 0x0600001D RID: 29 RVA: 0x00003B20 File Offset: 0x00001D20
		...
		// Token: 0x0600001E RID: 30 RVA: 0x00003C9C File Offset: 0x00001E9C
		...
		// Token: 0x0600001F RID: 31 RVA: 0x00003E70 File Offset: 0x00002070
